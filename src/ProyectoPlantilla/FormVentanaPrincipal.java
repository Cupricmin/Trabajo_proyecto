...
public class FormVentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        ...
                                        .addComponent(dateChFechaDctoProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addGap(78, 78, 78)
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(dateChFechaReportVenta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        try{
            if (filaSeleccionada == -1) //para validar que se seleccione fila
                ...
                {   //Obtener Datos del Jtable Venta
                    ...
                    // Actualizar cantidad en el Jtable de Busqueda de Producto
                    tblProductoEncontrado.setValueAt(NuevoStock, 0, 3);
    ...
    private void btnBuscarUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarUserActionPerformed
        ...
        if("".equals(txtNombUserBuscar.getText()))
            JOptionPane.showMessageDialog(null, "Ingrese coodigo a buscar.");
        else
    ...
    private void opBuscarUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opBuscarUserActionPerformed
        ...
        txtNombUserBuscar.setText("");
        DefaultTableModel dtUser = (DefaultTableModel) tblResultadoUsuario.getModel();
        dtUser.removeRow(0); // borrar el usuario anterior buscado
    ...
    private void btnRegistrarDctoProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarDctoProductoActionPerformed
        ...
        tbResulProducto.setModel(dtProductoDcto); // Asigna el Modelo de Tabla al JTable del Formulario para inicializarlo
    ...
    private void btnBuscarProduActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarProduActionPerformed
        ...
        { 
            ...
            try
            {
                ...
                dtDcto.addColumn("Codigo Dcto del Producto");  //Asigna nombre a cada columna del Modelo de Tabla
                dtDcto.addColumn("% Descuento");
                ...
                if(bandProd ==0)
                {
                    ...
                    fila = tbReportDcto.getSelectedRow();
                    while (fila >= 0) {
                        dtDcto.removeRow(fila);
                    }
                    
                }
                else
                {    
                    String queryDcP = "SELECT * from DctoProd WHERE CodProduc = "+codProd+""; // Buscar si el producto tiene descuento
                    ...
                    {   
                        ...
                        String queryDP = "SELECT MAX(IdDctoProd) AS IdDctoProd FROM DctoProd WHERE CodProduc = "+codProd+""; //selecciona el ultimo(MAX) registro de la tabla
                            
                        try
                        {                         
                            Statement stDP = con.ObtenerConexion().createStatement();
                            ResultSet rsDP = stDcP.executeQuery(queryDP);
    ...
    public javax.swing.JTable tblResultadoUsuario;
    private javax.swing.JTable tblVenta;
    private javax.swing.JTextField txtApellidoC;
    private javax.swing.JTextField txtCantidad;
    public javax.swing.JTextField txtCodDctoProd;
    ...
    public javax.swing.JTextField txtValorDcto;
